...
import { ShoppingCart, Truck, Shield, RotateCcw, ChevronLeft, Share } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { fetchProductById, findProductVariant } from "@/lib/products";
                    ...
                    {product.colors.map((color, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`inline-flex items-center gap-2 px-3 py-2 rounded-full border text-xs font-medium transition-all active:scale-95 ${
                ...
                <div className="flex gap-2 flex-wrap">
                  {["S","M","L","XL","XXL","XXXL"].map((size) => (
                    <Button
                      ...
                      className="min-w-[64px] h-11 font-medium text-sm active:scale-95 transition-transform"
                    >
                      {size}
                    </Button>
                  ))}
            ...
            <div className="bg-muted/20 rounded-lg p-4 space-y-3">
              <div className="grid grid-cols-3 gap-3 sm:gap-4">
                ...
                <div className="flex flex-col items-center text-center gap-1.5">
                  ...
                  <p className="text-[10px] sm:text-xs text-muted-foreground">30-day</p>
                </div>
                <div className="flex flex-col items-center text-center gap-1.5">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-accent/10 rounded-full flex items-center justify-center">
            ...
            <div className="bg-muted/20 rounded-lg p-4">
              <Tabs defaultValue="details" className="space-y-3">
                <TabsList className="grid w-full grid-cols-2 h-8">
                  <TabsTrigger value="details" className="text-xs font-medium">Details</TabsTrigger>
                  <TabsTrigger value="care" className="text-xs font-medium">Care</TabsTrigger>
                </TabsList>
